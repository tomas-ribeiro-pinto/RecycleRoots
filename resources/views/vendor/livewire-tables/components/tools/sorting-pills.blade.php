            ...
            <div class="mb-4 px-4 md:p-0" x-cloak x-show="!currentlyReorderingStatus">
                ...
                @foreach($component->getSorts() as $columnSelectName => $direction)
                    ...
                    <span
                        ...
                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-r_green-100 text-black capitalize dark:bg-indigo-200 dark:text-indigo-900"
                    >
                        ...
                        <button
                            ...
                            type="button"
                            class="flex-shrink-0 ml-0.5 h-4 w-4 rounded-full inline-flex items-center justify-center text-r_green-200 hover:bg-gray-300 hover:text-gray-500 focus:outline-none focus:bg-gray-500 focus:text-white"
                        >
