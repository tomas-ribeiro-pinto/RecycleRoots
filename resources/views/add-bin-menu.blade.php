<x-admin-layout>
    ...
    <div class="mt-6 mx-6">
        <a href="{{ route('bin-rules') . '/add' }}" class="text-md inline-flex items-center hover:underline font-semibold text-r_green-200">
