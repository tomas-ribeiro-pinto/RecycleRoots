<div class="flex gap-4">
    <x-table-button label="Edit" url="{{route('recycle-centres') . '/' . $row->id}}" icon="edit" :link="true" open_new_tab="true" colorClasses="text-r_green-200 hover:text-r_green-100"/>
    <div x-data="{ show: false}">
        ...
        <div x-show="show">
            <form method="POST" action="{{route('recycle-centres') . "/" . $row->id}}/remove">
                @csrf
